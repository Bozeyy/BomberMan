...
let questions = [
    ...
    {
        "question": "Quel est l'objectif principal des entretiens dans le recueil d'informations ?",
        "Reponses": ["Obtenir l'opinion de l'utilisateur sur le système", "Observer les utilisateurs", "Enregistrer les actions des utilisateurs", "Analyser les données recueillies"],
        "BonneReponse": "Obtenir l'opinion de l'utilisateur sur le système",
        "Explication": "Les entretiens visent à obtenir l'opinion de l'utilisateur sur le système."
    },
    {
        "question": "Quelle méthode de recueil d'informations implique d'interviewer un utilisateur dans son environnement de travail à propos d'un événement marquant ?",
        "Reponses": ["Technique de l'incident critique", "Observation directe", "Questionnaires", "Workshop"],
        "BonneReponse": "Technique de l'incident critique",
        "Explication": "La technique de l'incident critique implique d'interviewer un utilisateur dans son environnement de travail à propos d'un événement marquant."
    },
    {
        "question": "Quel type d'observation est utilisé pour identifier les gros problèmes d'utilisabilité ?",
        "Reponses": ["Observation directe", "Entretiens", "Questionnaires", "Espionnage"],
        "BonneReponse": "Observation directe",
        "Explication": "L'observation directe est utilisée pour identifier les gros problèmes d'utilisabilité."
    },
    {
        "question": "Combien d'utilisateurs minimum devraient être choisis parmi le public visé pour une étude d'utilisation ?",
        "Reponses": ["Au moins 2", "Au moins 5", "Au moins 10", "Au moins 3"],
        "BonneReponse": "Au moins 2",
        "Explication": "Pour une étude d'utilisation, il est recommandé de choisir au moins 2 utilisateurs parmi le public visé."
    },
    {
        "question": "Quelle est une technique courante pour enregistrer les observations pendant une étude d'utilisation ?",
        "Reponses": ["Enregistrement papier", "Enregistrement audio", "Enregistrement vidéo", "Toutes les réponses sont correctes"],
        "BonneReponse": "Toutes les réponses sont correctes",
        "Explication": "Les enregistrements papier, audio et vidéo sont des techniques courantes pour enregistrer les observations pendant une étude d'utilisation."
    },
    {
